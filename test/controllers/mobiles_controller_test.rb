...
class MobilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mobile" do
    assert_difference("Mobile.count") do
      post mobiles_url, params: { mobile: { brand_name: @mobile.brand_name, price: @mobile.price, ram: @mobile.ram, rom: @mobile.rom } }
    end
  ...
  test "should update mobile" do
    patch mobile_url(@mobile), params: { mobile: { brand_name: @mobile.brand_name, price: @mobile.price, ram: @mobile.ram, rom: @mobile.rom } }
